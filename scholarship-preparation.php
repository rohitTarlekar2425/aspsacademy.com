...
<?php include('header.php') ?>
  ...
  <main class="main">
    ...
    <div class="site-breadcrumb" style="background: url(assets/img/breadcrumb/01.png)">
      <div class="container">
        <h2 class="breadcrumb-title">Scholarship Preparation (4th & 7th)</h2>
        <ul class="breadcrumb-menu">
          <li><a href="index.php">Home</a></li>
          <li class="active">Scholarship Preparation (4th & 7th)  </li>
        </ul>
      </div>
    </div>
    <!-- breadcrumb end -->
  ...
  <div class="tab-pane fade active show" id="course-tab1">
    <div class="course-details mt-4">
      ...
      <div class="mb-4">
        ...
        <p>
          ASP's Academy offers focused Scholarship Preparation for students
          appearing for the 4th and 7th Standard Scholarship Examination.
          The program is designed to strengthen students' fundamentals,
          improve logical and analytical thinking, develop problem-solving
          skills and build confidence for the scholarship examination.
        </p>

        <p>
          Students receive structured teaching, topic-wise practice,
          regular tests, revision sessions, previous question paper practice
          and personalized guidance. Special attention is given to improving
          speed, accuracy, time management and examination techniques.
        </p>
      </div>
      ...
      <div class="mb-4">
        ...
        <p>
          This course is designed for students preparing for the 4th and
          7th Standard Scholarship Examination. Students should attend
          regular classes, complete assigned practice work and participate
          in tests and revision sessions.
        </p>

        <ul class="course-list">
          <li>
            <i class="far fa-check"></i>
            Specially designed for 4th and 7th Standard scholarship aspirants.
          </li>

          <li>
            <i class="far fa-check"></i>
            Strong foundation in Mathematics, Language and Intelligence.
          </li>

          <li>
            <i class="far fa-check"></i>
            Regular topic-wise practice and problem-solving sessions.
          </li>

          <li>
            <i class="far fa-check"></i>
            Previous year question paper and exam-pattern practice.
          </li>

          <li>
            <i class="far fa-check"></i>
            Regular mock tests, revision and performance analysis.
          </li>

          <li>
            <i class="far fa-check"></i>
            Focus on speed, accuracy, logical thinking and time management.
          </li>
        </ul>
      </div>
            ...
            <div class="accordion-body">
              ...
              <div class="curriculum-item unlock">
                <div class="left">
                  <h6>
                    <i class="fad fa-play-circle"></i>
                    <span>Subject:</span> Intelligence & Reasoning
                  </h6>
                </div>
              ...
              <div class="curriculum-item">
                <div class="left">
                  <h6>
                    ...
                    <span>Practice:</span> Topic-wise Question Practice
                  </h6>
                </div>
              ...
              <div class="curriculum-item">
                <div class="left">
                  <h6>
                    <i class="fad fa-file-alt"></i>
                    <span>Practice:</span> Previous Year Question Papers
                  </h6>
                </div>
              ...
              <div class="curriculum-item">
                <div class="left">
                  <h6>
                    <i class="fad fa-check-circle"></i>
                    <span>Tests:</span> Scholarship Mock Tests
                  </h6>
                </div>
            ...
            <div class="accordion-body">
              ...
              <div class="curriculum-item">
                <div class="left">
                  <h6>
                    <i class="fad fa-play-circle"></i>
                    <span>Preparation:</span> Scholarship Exam Pattern
                  </h6>
                </div>
              ...
              <div class="curriculum-item">
                <div class="left">
                  <h6>
                    <i class="fad fa-file-alt"></i>
                    <span>Practice:</span> Previous Year Papers
                  </h6>
                </div>
              ...
              <div class="curriculum-item">
                <div class="left">
                  <h6>
                    <i class="fad fa-check-circle"></i>
                    <span>Tests:</span> Full-Length Mock Tests
                  </h6>
                </div>
              ...
              <div class="curriculum-item">
                <div class="left">
                  <h6>
                    ...
                    <span>Analysis:</span> Test Performance & Improvement
                  </h6>
                </div>
              ...
              <div class="curriculum-item">
                <div class="left">
                  <h6>
                    ...
                    <span>Revision:</span> Complete Syllabus Revision
                  </h6>
                </div>
              ...
              <div class="curriculum-item">
                <div class="left">
                  <h6>
                    ...
                    <span>Practice:</span> Speed & Accuracy
                  </h6>
                </div>
              ...
              <div class="curriculum-item">
                <div class="left">
                  <h6>
                    ...
                    <span>Final:</span> Scholarship Exam Strategy
                  </h6>
                </div>

                <div class="right">
                  <span class="duration">Final</span>
                  <span class="lock">
                    <i class="fad fa-lock"></i>
                  </span>
                </div>
  ...
  <div class="tab-pane fade" id="course-tab3">
    <div class="course-instructor mt-4">
      ...
      <div class="instructor-info">
        ...
        <p>
          ASP's Academy provides dedicated guidance for students preparing
          for the 4th and 7th Standard Scholarship Examination. Our faculty
          focuses on concept clarity, logical thinking, regular practice,
          problem-solving, mock tests and personalized guidance to help
          students improve their speed, accuracy and overall examination
          performance.
        </p>
